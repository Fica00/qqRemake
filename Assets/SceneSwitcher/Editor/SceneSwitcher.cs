	...
	public class SceneSwitchLeftButton
	{
		...
		static void OnToolbarGUI()
		{
			...
			for (int i = 0; i < EditorBuildSettings.scenes.Length; i++)
			{
				...
				string sceneName = EditorBuildSettings.scenes[i].path.Split('/').Last().Replace(".unity", "");
				if (GUILayout.Button(new GUIContent(sceneName[0].ToString(), sceneName), ToolbarStyles.commandButtonStyle))
				{
